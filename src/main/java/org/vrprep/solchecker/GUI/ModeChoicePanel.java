...
public class ModeChoicePanel extends JPanel implements ActionListener {
    ...
    MultiplePanel multiplePanel = new MultiplePanel();
    ...
    public boolean individualSolcheckerIsSelected(){
        return individualButton.isSelected();
    }
    
    public File getSolutionFile(){
        return individualPanel.getSolutionFile();
    }
    
    public File getInstanceFile(){
        return individualPanel.getInstanceFile();
    }
    
    public File getBatchFile(){
        return multiplePanel.getBatchFile();
    }
